...
urlpatterns += patterns('known.views',
    ...
    (r'^known/article/(?P<id>\d*)/detail/$', 'detailArticle'),
    (r'^known/article/(?P<id>\d+)/update/$', 'updateArticle'),
    (r'^known/article/(?P<id>\d+)/delete/$', 'deleteArticle'),
    (r'^known/article/folder/(?P<folder>\w+)/(?P<pageNum>\d*)$', 'listByFolder'),
    (r'^known/article/status/(?P<status>\d+)/(?P<pageNum>\d*)$', 'listByStatus'),
)